...
def main():
    ...
    parser.add_argument('--checkpoint_path', default="/home/sam/SingFake/models/dac/outdir/mix_draft/chkpt")
    parser.add_argument('--name', default='best_model.ckpt-344_g.pt')
    ...
    parser.add_argument('--discriminator_path', default='outdir/mix_draft/chkpt', type=str)
    parser.add_argument('--discriminator_name', default='best_model.ckpt-344_d.pt')
    a = parser.parse_args()
