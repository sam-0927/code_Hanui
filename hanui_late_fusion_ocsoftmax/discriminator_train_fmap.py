...
def main():
    ...
    parser.add_argument("--train_dir", default=Path('/ssd2/Database/singfake/mixtures/train'), type=Path)
    parser.add_argument("--test_dir", default=Path('/ssd2/Database/singfake/mixtures/'), type=Path)
