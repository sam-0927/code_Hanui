...
class Train(object):
    ...
    def _run_one_epoch(self, train=True):
        ...
        for i, batch in enumerate(pbar):
            ...
            #disc_mrd_loss = dag_fdd_loss(disc_mrd_loss)
            ...
            pbar.set_description("CE loss: {:.5f}".format(disc_loss.item()))
            
            self.global_step += 1
        #if self.global_step > 400000:
    ...
    def _run_one_epoch_eval(self):
        ...
        for i, batch in enumerate(pbar):
            ...
            disc_mrd_loss = self.ce_loss(pred_label, key)
