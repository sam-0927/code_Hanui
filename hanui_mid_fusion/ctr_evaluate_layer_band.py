...
def main():
    ...
    parser.add_argument("--test_dir", default=Path('/home/sam/DB/ctrsvdd/test_set_4sec/'), type=Path)
    parser.add_argument("--dev_dir", default=Path('/home/sam/DB/ctrsvdd/dev_set_4sec/'), type=Path)
